...
#I need a universal navigation functionality#
#This should allow users to go to the home page and see the contents at anytime#
pygame.init()
...
pygame.display.set_caption('Discipuli 1.9.3')
